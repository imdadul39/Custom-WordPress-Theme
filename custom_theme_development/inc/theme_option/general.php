...
<div id="theme_optin_body">
    <div class="main_area_option">
        ...
        <form action="options.php" method="post">
            ...
            <input type="text" name="phone-number" value="<?php echo get_option('phone-number'); ?>" placeholder="Enter Your Number">


            <label for="xpent_logo" name="xpent_logo">Logo Upload</label>
            <input type="file" name="xpent_logo" value="<?php echo get_option('xpent_logo'); ?>" >
            

            <input type="hidden" name="action" value="update">
            <input type="hidden" name="page_options" value="address-info, email-info, phone-number, theme-logo">
